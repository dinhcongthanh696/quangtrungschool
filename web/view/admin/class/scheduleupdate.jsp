    ...
    <body>
        <jsp:include page="../header.jsp"></jsp:include>
            <section class="right">
                ...
                Teacher Code :  <input disabled="disabled" value="${param.teacherCode}" class="form-control"> 
                ...
                <select id="teacher" name="teacher" class="form-select">
                    <c:forEach items="${requestScope.teachers}" var="teacher">
                        <option value="${teacher.teacherCode}" ${teacher.teacherCode eq param.teacherCode ? "selected='selected'" : ""}>
